...
[玉伯知乎原文](https://www.zhihu.com/question/20351507)
```js
// CMD
...
于是，像`webpack`，`rollup`，`parcel`等打包工具，把ESM转成其他模块规范
...
于是出现了像`Vite`这样利用原生import导入的工具，开发环境下把打包工作交给浏览器，相比传统打包工具要节省许多时间
