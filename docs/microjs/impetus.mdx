...
:::tip
给任何事情增加动力。它就像iScroll，除了不滚动。支持鼠标和触摸事件
:::

:pushpin:鼠标拖动：

![在这里插入图片描述](https://img-blog.csdnimg.cn/a17f6acca51b49aebe5b407ff3ec2f27.gif)

:jack_o_lantern:手指触控：

![在这里插入图片描述](https://img-blog.csdnimg.cn/24e239cd312e4ebbba33099b704f359a.gif)
